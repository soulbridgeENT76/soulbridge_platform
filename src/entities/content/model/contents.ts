...
export const CONTENTS: Content[] = [
  {
    ...
    synopsis: `세상 어딘가에서 조용히 사람과 사람을 잇고 있는 이들을 찾아 나선 인터뷰 다큐멘터리입니다.
...
제작총괄 손정은`,
  ...
  },
  {
    ...
    year: "2026",
    note: "교양 시리즈",
    synopsis: `우리는 하루에도 수없이 마음을 주고받지만, 그 온도를 들여다볼 틈은 좀처럼 없습니다.
...
진행 손정은`,
  ...
  },
  {
    ...
    year: "2027",
    note: "공동 기획",
    synopsis: `독점 원천 IP를 바탕으로 개발 중인 오리지널 드라마입니다.
...
제작총괄 손정은`,
  },
  {
    ...
    year: "2028",
    note: "글로벌 유통",
    synopsis: `단절의 시대에 '연결'은 기술일까, 마음일까.
글로벌 OTT 유통을 목표로 기획 중인 웰메이드 콘텐츠로, 문화와 언어를 넘어 공감을 만들어내는 이야기를 지향합니다.
원천 IP의 힘을 국제 무대에서 증명할 소울브릿지의 글로벌 도전작입니다.
...
제작총괄 손정은`,
  },
  {
    ...
    year: "2027",
    note: "로크미디어 제휴",
    synopsis: `로크미디어와 함께 선보이는 오리지널 웹툰입니다.
...
IP 매니지먼트 소울브릿지ENT`,
  },
  {
    ...
    year: "2027",
    note: "원천 IP",
    synopsis: `모두가 잠든 시각, 한 통의 인터뷰 요청으로 시작되는 미스터리 웹소설입니다.
